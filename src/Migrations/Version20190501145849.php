 ...
 */
final class Version20190501145849 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE song (id INT AUTO_INCREMENT NOT NULL, owner_id INT NOT NULL, title VARCHAR(64) NOT NULL, genre VARCHAR(64) DEFAULT NULL, singer VARCHAR(64) NOT NULL, duration TIME DEFAULT NULL, INDEX IDX_33EDEEA17E3C61F9 (owner_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
